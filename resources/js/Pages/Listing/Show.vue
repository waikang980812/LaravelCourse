        ...
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <div>
                    ...
                    <label class="label">Interest rate ({{ duration }} years)</label>
            ...
            <MakeOffer @offer-updated="offer = $event" :listing-id="listing.id" :price="listing.price"
                v-if="user && !offerMade" />
...
//     const principle = Number(props.listing.price); // Ensure this is a number
//     const monthlyInterest = Number(interestRate.value) / 100 / 12;
//     const numberOfPaymentMonths = Number(duration.value) * 12;

//     const numerator = principle * monthlyInterest * Math.pow(1 + monthlyInterest, numberOfPaymentMonths);
